      ...
      const todayExpenses = [
        {
          ...
          expense: "Grocery",
          time: "5:12 pm",
          location: "Relanja di pasar",
          price: 326.80,
          icon: cartIcon,
          iconBackgroundColour: "#32a7e2", 
        },
        {
          id: 2,
      ...
      const previousExpenses = [
        {
          ...
          price: 165.0,
          icon: cartIcon,
          iconBackgroundColour: "#DCDC34", 
        },
        {
          id: 2,
          expense: "Entertainment",
          time: "5:12 pm",
          location: "Nnnton bioskop",
          price: 35.2,
          icon: transportIcon,
          iconBackgroundColour: "#4ba83d", 
        },
      ];
            ...
            <div className={styles.expensesCard}>
                <section className={styles.expensesOverview}>
                        ...
                        <BarChart data={data}>
                            <Bar dataKey="uv" fill="rgba(21, 122, 255, .2)" onMouseOver={onMouseOver}>
                                {data.map((entry, index) => (
                                    <Cell cursor="pointer" fill={index === activeIndex ? 'rgba(21, 122, 255)' : 'rgba(21, 122, 255, .2)'} 
                                    key={index}
                                    />
                                ))}
                            </Bar>
                    ...
                    <ul>
                      {todayExpenses.map(expense => 
                         ...
                         <div className={styles.expenseItemLeft}>
                           <div style={{backgroundColor: expense.iconBackgroundColour}} className={styles.expenseItemDiv}>
                    ...
                    <ul>
                      {previousExpenses.map(expense => 
                         ...
                         <p className={styles.expenseItemPrice}>{expense.price.toFixed(2)}
                ...
                <section className={styles.moneyOverview}>
                  ...
                  <div className={styles.saveMoneyDiv}>
                    ...
                    <p className={styles.saveMoneyInfo}>elusmod tempor incidudunt ut labore et dolore magna aliqua. Ut enim ad minim.</p>
